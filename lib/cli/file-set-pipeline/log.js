...
function log(context) {
    ...
    if (!context.watch) {
        ...
        /*
         * We add a little time interval before reports are printed out, because
         * without the interval, the logUpdate('') above seems to also eat up
         * the last line of the plugins' output.
         */
