...
function run(cli, isFirstRunOfWatchSession, done) {
    ...
    fileSetPipeline.run(cli, function (err) {
         ...
         * animation, but it does not clear out the spinner off of the console.
         ...
         * the console.
         * If we do that here, the last line of all the plugins' output will be
         * erased, instead of the spinner.
         */
    ...
    if (!isFirstRunOfWatchSession) {
         ...
         * pipeline run could get deleted, when ./file-set-pipeline/log.js tries
         * to clear out the spinner.
         *
         * In contrast, if the following is called also on the *first* pipeline
         * run, then you will see an extra spinner.
         */
